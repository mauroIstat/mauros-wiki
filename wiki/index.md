...
This wiki is a compact writing aid built from the corpus in `sources_md/`.

Use it this way:

- Start with [overview.md](/home/mauro/projects/mauros-wiki/wiki/overview.md) for the main research profile.
- Read [recurring_themes.md](/home/mauro/projects/mauros-wiki/wiki/recurring_themes.md) for the ideas that recur across papers, chapters, notes, and slides.
- Read [methodological_framing.md](/home/mauro/projects/mauros-wiki/wiki/methodological_framing.md) before drafting methods, contributions, limitations, or discussion sections.
- Read [writing_voice.md](/home/mauro/projects/mauros-wiki/wiki/writing_voice.md) when the goal is stylistic continuity with the corpus.
- Read [key_projects.md](/home/mauro/projects/mauros-wiki/wiki/key_projects.md) for reusable case studies and application areas.
- Read [terminology.md](/home/mauro/projects/mauros-wiki/wiki/terminology.md) to keep wording aligned with the source material.
