...
The dominant application area is semantic integration of textual data. Several documents focus on turning unstructured text into structured statistical information through embedding-based retrieval, semantic search, information extraction, and uncertainty-aware automatic coding. The recurring classification targets are ATECO/NACE, ISCO, profession taxonomies such as CP2021, PRODCOM, ICD-10, and controlled institutional actor typologies. The recurring input sources are user-entered activity descriptions, company websites, patent abstracts, survey-related material, metadata in dissemination platforms, profession labels interpreted within richer task and context descriptions, death-certificate medical expressions, and formal agreements or protocols.
...
- Data-integration AI: survey-document comparison, document-to-structure pipelines, named-entity extraction, and quality checks that use textual evidence to complement self-reported data.
