...
## [2026-04-14] ingest | initial corpus
Pages created: `wiki/index.md`, `wiki/overview.md`, `wiki/glossary.md`, `wiki/log.md`, 8 source pages, 4 topic pages, 4 project pages, 4 concept pages, 2 snippet pages, 3 style pages.
Pages updated: none.
Key additions: first grounded taxonomy for AI in Official Statistics; source pages for all 8 PDFs; synthesis around semantic integration, trustworthy AI, reliability, and teaching tone.
Open issues: some project-level details are visible mainly through slide decks; future source ingestion should strengthen chronology, institutional contexts, and reusable snippets where more evidence appears.

## [2026-04-14] ingest | added 2025 chapter and papers
Pages created: 3 source pages, 2 project pages.
